...
body {
	background:url(https://moustique.cdnartwhere.eu/sites/default/files/styles/large/public/field/image/cqlf_records_sh460_04351.jpg?itok=Y-2lfsfd);
}
#dash {
	margin:0 auto;
	width:600px;
...
<table width="100%" border="0" cellpadding="0" cellspacing="3" style="background:#FFF; border-bottom:1px solid #CCC; border-left:1px solid #CCC; border-right:1px solid #CCC; padding:5px;">
  ...
  <tr>
    <td width="24%" style="text-align: left"><p style="color:#333; padding:5px 0;">De: </p></td>
  ...
  <tr>
    <td style="text-align: left"><p style="color:#333; padding:5px 0;">Assunto: </p></td>
  ...
  <tr>
    <td style="text-align: left"><p style="color:#333; padding:5px 0;">Lista/mails:</p></td>
    <td>
