...
get_header(); ?>
<div class="main-container page-contacts bg-el">
        ...
        <div class="contacts-block">
            <div class="tel">
                ...
                <div class="footer__tel">
                    <?= get_template_part('components/get-phones'); ?>

                </div>
            </div>
            <div class="email">
                <span>Электронная почта: </span>
                <a href="mailto:<?= the_field('email', 'options') ?>"><svg width="20" height="14" viewBox="0 0 20 14"
